...
type RendererStoreExtension = {
    screens: Record<string, StateScreen>;
    mainmenu: StateMainmenuItems;
};
export type { SettingsIcons, EmitterEventsMap, StateScreen, StateScreens, PossibleScreen, StateMainmenuItem, StateMainmenuItems, SolidRendererStore, CreateSolidRendererOptions, RendererStoreExtension };
